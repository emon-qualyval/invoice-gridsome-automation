          ...
          <v-row no-gutters class="mx-auto invoiceInformation">
            <v-col cols="12" sm="5" class="ml-5 left">
              ...
              <p class="d-flex">
                ...
                <date-picker class="mt-3 ml-3" style="background:#003eb8" v-model="time1" valueType="format"></date-picker>
              </p>
            </v-col>
...
export default {
  ...
  data: () => ({
    ...
    time1: new Date(Date.now() - new Date().getTimezoneOffset() * 60000)
                    .toISOString()
                    .substr(0, 10),
    item: "",
    unit: "",
